...
namespace chatable.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordRequest reset, [FromServices] Client client)
        {
            try
            {
